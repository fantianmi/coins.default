function DisplayHot() {
 ...
 var zhangdiefu2 = XMLHttpReq.responseXML.getElementsByTagName("zhangdiefu2")[0].firstChild.nodeValue;
 var zhangdiefu3 = XMLHttpReq.responseXML.getElementsByTagName("zhangdiefu3")[0].firstChild.nodeValue;
   ...
   document.getElementById("zhangdiefu2").innerHTML = zhangdiefu2;
   document.getElementById("liutongzhi").innerHTML = (amount*latestprice/2).toFixed(0).replace(/(\d+?)(?=(?:\d{3})+$)/g, '$1,');
   if(zhangdiefu3>=0){
	   document.getElementById("chart-hd").innerHTML="涨幅↑";
   }else{
	   document.getElementById("chart-hd").innerHTML="跌幅↓";
   }
 }
