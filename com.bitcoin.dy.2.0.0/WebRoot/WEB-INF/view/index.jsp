...
<div class="full-screen-slider" >
 	 <ul id="slides">
    <li style="background:url('slider/01.jpg') no-repeat center top"></li>
    <li style="background:url('slider/02.jpg') no-repeat center top"></li>
  ...
  <div class="lhead"><span>&nbsp;&nbsp;用户登陆</span></div>
  <div class="lform">
  <div id="index_account_panel">
  <script>
  function doLogin(){
	  if(checkIsNull("uusername")==true||checkIsNull("upassword")){alert("用户名密码不能为空");return false;}
	  document.getElementById("loginform").submit();	
  }
  </script>
	<form method="post" action="vertify.do" class="login-form form-horizontal ng-pristine ng-valid" role="form" id="loginform">
        <div class="form-group">
          <div class="col-xs-12">
          <input class="form-control"  name="uusername" id="uusername" style="background-repeat: no-repeat; padding-left:32px">
          </div>
        </div>
        <div class="form-group">
          <div class="col-xs-12">
        ...
        <div class="form-group">
        <button name="login" type="button" onclick="doLogin();" class="btn btn-block btn-lg blue">登录</button>
 		</div>       
      </form>
      <div class="login-control">
       	 <span class="link pull-left" style="color:#888">还没有账号？</span><a href="index.do?Register" id="registration" class="link pull-left">免费注册</a>
        <a href="index.do?findpass&type=upass" id="forget_pwd" class="gray-link pull-right"> 忘记密码</a>
      </div>
  </div>
  </div>  
  <%}else{ %>
  ...
  <div class="logged-panel" style="margin-bottom: 30px">
      ...
      <a href="index.do?stock&stockId=<%=stockres.getString("stock.default.stockid")%>" class="btn btn-lg btn-block blue" style="width:203px;margin-left:10px;"> 交易中心</a>
      <a href="index.do?logout" class="btn btn-block dark" style="width:203px;margin-left:10px;"> 退出</a>
    </div>
  <!-- logged-panel -->
  </div>
  </div>
...
<div class="wrapper row3" style="">
	...
	<p><%=stockres.getString("stock.default.name") %><span style="" id="vol_cnyltc">0</span></p>
	</li>
...
<script type="text/javascript">
	...
	function getDayLine() {
		...
		if (ajaxObj7 != null) {
			var url = 'ajax.do?hicharts&stockId=<%=stockres.getString("stock.default.stockid")%>&exstock=cny&type=day&n='+ Math.random();
	...
	function getTimeLine() {
		...
		if (ajaxObj6 != null) {
			var url = 'ajax.do?hicharts&stockId=<%=stockres.getString("stock.default.stockid")%>&exstock=cny&type=hours&n='+Math.random();
	...
	function get5minLine() {
		...
		if (ajaxObj8 != null) {
			var url = 'ajax.do?hicharts&stockId=<%=stockres.getString("stock.default.stockid")%>&exstock=cny&type=min&n='+Math.random();
...
<div class="wrapper row3" style="padding-top:0px">
  <div id="container" style="padding-top:5px">
    ...
    <div id="sidebar_1" >
<!--########################################################-->
<h2 style="text-align: center;font-size: 20px;font-weight: 800;margin-bottom: 0px;color:#0171C7">为什么选择我们</h2>
      ...
      <ul class="clear">
        ...
        <li class="one_third">
          <article class="clear">
            ...
            <p>平台承诺永久性免收充值手续费，体现平台真正让利于广大用户的互惠价值观。</p>
          </article>
        </li>
        <li class="one_third first">
          <article class="clear">
            ...
            <a href="#"><span class="indextitle">技术力量</span></a>
            </figure>
            <p>强大的技术团队支撑，安全稳定，注重用户体验</p>
          </article>
        </li>
        <li class="one_third">
          <article class="clear">
